...
struct qt_meta_stringdata_CLASSContextMenuENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSContextMenuENDCLASS = QtMocHelpers::stringData(
    "ContextMenu"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSContextMenuENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject ContextMenu::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSContextMenuENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSContextMenuENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSContextMenuENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *ContextMenu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSContextMenuENDCLASS.stringdata0))
